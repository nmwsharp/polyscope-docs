This section demonstrates using Polyscope with [openMesh](https://www.graphics.rwth-aachen.de/software/openmesh/). 

This example is from [https://github.com/vijaiaeroastro/openMeshPolyscope](https://github.com/vijaiaeroastro/openMeshPolyscope). See the repository for a sample project configuration, build system, and a quick demo!

Note: this example _does not_ make use of Polyscope's templated data adaptors, but instead simply copies data in to new containers for Polyscope.

![openMesh example]([[url.prefix]]/media/openmesh_example.png)
